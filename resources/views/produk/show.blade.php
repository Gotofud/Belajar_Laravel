    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Show Produk</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                                    ...
                                    <div class="col-lg-12">
                                        <form action="{{ route('produk.edit', $produk->id)}}" method="POST"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="nama_produk" value="{{$produk->nama_produk}}" disabled>
                                            </div>
                                            <div class="form-group">
                                                <label>Kategori : </label>
                                                <select name="id_kategori" class="form-control" disabled>
                                            ...
                                            <div class="form-group">
                                                <label>Harga : </label>
                                                <input class="form-control" name="harga" value="{{$produk->harga}}" disabled>
                                            </div>
                                            <div class="form-group">
                                                <label>Stok : </label>
